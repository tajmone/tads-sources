...
long BuiltinRegex::FindText(Document *doc, int minPos, int maxPos, const char *s,
                        bool caseSensitive, bool word, bool, int flags,
                        int *length) {
        ...
        for (int line = lineRangeStart; line != lineRangeBreak; line += increment) {
                ...
                int success = search.Execute(di, startOfLine, endOfLine, word);//[mjr - added 'word']
                if (success) {
                        pos = search.bopat[0];
                        ...
                        if ((increment == -1) && (s[0] != '^')) {
                                ...
                                while (success && (search.eopat[0] <= endOfLine) && (repetitions--)) {
                                        success = search.Execute(di, pos+1, endOfLine, word);//[mjr - added 'word']
                                        if (success) {
